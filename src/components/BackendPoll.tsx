...
const BackendPoll = () => {
  ...
  useEffect(() => {
    // Check if user has already voted in this session for backend poll
    const voted = sessionStorage.getItem("hasVotedBackend");
    const votedOption = sessionStorage.getItem("selectedBackendOption");
  ...
  const handleVote = (optionId: string) => {
    ...
    sessionStorage.setItem("hasVotedBackend", "true");
    sessionStorage.setItem("selectedBackendOption", optionId);
  };

  const resetPoll = () => {
    sessionStorage.removeItem("hasVotedBackend");
    sessionStorage.removeItem("selectedBackendOption");
    setHasVoted(false);
    setSelectedOption("");
  };

  return (
    <section className="section-container bg-gradient-to-br from-green-50 to-blue-100" id="poll">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="section-title text-foreground mb-4">
            Backend Technologies Poll 2024
          </h2>
          <p className="section-subtitle mx-auto">
            Which backend technology do you prefer for server-side development?
          </p>
            ...
            <CardHeader>
              ...
              <CardDescription>
                {hasVoted 
                  ...
                  : "Choose your preferred backend technology below."
                }
              </CardDescription>
            </CardHeader>
